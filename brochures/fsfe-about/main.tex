...
\subsection{Public Money Public Code}
    ...
    ¿Crees que el Software Libre debe ser la opción principal para el software financiado públicamente? Necesitamos convencer a los políticos que nos representan, súmate firmando la carta abierta\footnote{https://publiccode.eu/openletter}

\subsection{Save Code Share}

    Es una iniciativa lanzadada por la FSFE y OpenForum Europe en septiembre del 2017. Pretenede llamar la atención sobre el impacto no intencionado del art. 13 de la Directiva de Copyright propuesta Directive on software sharing platforms. La iniciativa pretende mostrar mediante un documento blanco\footnote{https://savecodeshare.eu/static/assets/WhitePaper-ImpactofArticel13onSoftwareEcosystem-SaveCodeShare.pdf} que se precisa un mayor análisis para entender el funcionamiento de la innovación en el mercado actual. Este es el primer paso para crear un marco regulatorio adecuado. 

    La revisión actual del Copyright en la UE\footnote{http://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:52016PC0593} amenza al Software Libre y al Código Abierto.
    Actúa para preservar la capacidad de construir software de forma colaborativa firmando la carta abierta\footnote{https://savecodeshare.eu/\#research} que enviaremos a los europarlamentarios y al consejo europeo
    

\subsection{Pregunta a tus candidatos}

    Durante elecciones locales, federales y parlamentarias, la FSFE hace una llamada a todos los defesores del Software Libre para preguntar a los partidos sus posiciones respecto el Software Libre y los Estándares Abiertos.
